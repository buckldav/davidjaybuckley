...
const MusicGrid = props => (
  <div className="masonry-css">
    ...
    <div className="masonry-css-item">
      <img src={"/img/music/bass-roc.jpg"} width="100%" alt="BYU ROC band"/>
      <div className="callout">On national TV! In 2018, I played bass in the BYU ROC band for the basketball games.</div>
    </div>
    <div className="masonry-css-item">
      <img src={"/img/music/organ.jpg"} width="100%" alt="David Buckley - Organ Player"/>
    </div>
    <div className="masonry-css-item">
    ...
    <div className="masonry-css-item">
      <img src={"/img/music/the-guests.png"} width="100%" alt="The Guests"/>
    </div>
    <div className="masonry-css-item">
      <div className="callout">
    ...
    <div className="masonry-css-item">
      <img src={"/img/music/mjo.jpg"} width="100%" alt="David Buckley - Jazz Guitarist"/>
    ...
    <div className="masonry-css-item">
      <img src={"/img/music/pinas-bass.jpg"} width="100%" alt="Upright bass in the Philippines"/>
    </div>
    <div className="masonry-css-item">
      <img src={"/img/music/mjo-group.jpg"} width="100%" alt="Mountainside Jazz Orchestra"/>
      <div className="callout">
